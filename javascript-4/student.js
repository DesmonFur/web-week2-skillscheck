...
let faveColors = [ 'black', 'yellow', 'blackNyellow']
...
let me = {
    ...
    superHeroName: 'Dezz',
    homeTown: 'Piedmont',
    superPowers: ['Licking', 'Kicking', 'Time travel'],
    superPowerXp: function(num) {
...
//////////////////Step 6////////////////////
//Lastly, create a function called redactInfo that will take in an obj as a paramter. Let's imagine our super hero needs to go undercover and we need to remove all info about them. 
