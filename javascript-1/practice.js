...
// Have the function take the two parameters and retrun a string that says "NAMEPARAM loves LOVEPARAM" with the appropriate parameters in the string. e.g. "Bryan loves skateboarding"
...
colorCopy.push('matt is awesome')
...
// firstName will be your name as a string. state will be your current state or providence as a string. age will be your age as a number. 
...
// Next up, reduce to get the total of the array. call the new array 'total'
 ...
 let total = myNumbers.reduce( ( myNumbers, cv) => {
	return myNumbers + cv
  })
